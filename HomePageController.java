...
import themstore.DAO.IPersonne;
...
private AnchorPane rootLayout;
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     btn_add.setOnAction(event -> {
            ...
            try {
                Parent page1 = FXMLLoader.load(getClass().getResource("/themstore/View/AddUser.fxml"));
...
//                controller.setListData(new ListData());
     ...
     btn_pass.setOnAction(event -> {
            try {//FXMLLoader loader = new FXMLLoader();
                //loader.setLocation(getClass().getResource("/com/esprit/view/Accueil.fxml"));
                Parent page2 = FXMLLoader.load(getClass().getResource("/themstore/View/ListOublie.fxml"));
                // Give the controller access to the main app.
//                AfficherPersonneController controller =loader.getController();
//                controller.setListData(new ListData());
                Scene scene = new Scene(page2);
     ...
     btn_mail.setOnAction(event -> {
            try {//FXMLLoader loader = new FXMLLoader();
                //loader.setLocation(getClass().getResource("/com/esprit/view/Accueil.fxml"));
                Parent page2 = FXMLLoader.load(getClass().getResource("/themstore/View/Repairpassword.fxml"));
                // Give the controller access to the main app.
//                AfficherPersonneController controller =loader.getController();
//                controller.setListData(new ListData());
                Scene scene = new Scene(page2);
 ...
 /* void setUserInfo(int id) {
            ...
            id = AccueilController.test ;
            
            PersonneDAO li = new PersonneDAO();
            Personne p =li.displayById(id); 
            name.setText(p.getNom());
            lname.setText(p.getPrenom());
